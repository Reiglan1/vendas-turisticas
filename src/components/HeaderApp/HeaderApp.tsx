...
interface MenuItem {
  ...
  submenuItems?: string[];
  link?: string;
  scrollTo?: string; // ID da seção para scroll (ex: "#destinos")
}
...
export default function HeaderApp() {
  ...
  return (
    <header className="bg-gradient-to-r from-azul-1 to-blue-700 fixed top-0 left-0 right-0 z-50 shadow-lg">
      ...
      {/* Mobile Menu */}
      <div
        className={`lg:hidden fixed top-[70px] left-0 right-0 bg-gradient-to-r from-azul-1 to-blue-700 transition-all duration-300 overflow-hidden ${mobileMenuOpen ? "max-h-screen opacity-100" : "max-h-0 opacity-0"
          }`}
      >
